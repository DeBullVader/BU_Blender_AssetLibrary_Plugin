...
class BU_OT_Render_Previews(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        peview_blend_filepath =f'{addon_path}{os.sep}BU_plugin_assets{os.sep}blend_files{os.sep}Preview_Rendering.blend'
        with bpy.data.libraries.load(peview_blend_filepath) as (data_from, data_to):
            print(data_from.scenes[0])
